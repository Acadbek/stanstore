  ...
  return (
    ...
    >
      <div
        ...
        style={{
          borderRadius: cr,
          background: coverImage ? undefined : s.productBadge,
        }}
      >
        {coverImage ? (
          <img
...
function ProductCardCompact({ title, price, s, cr, coverImage, coverAlt }: ProductCardProps) {
  return (
    <div
...
function ProductCardOverlay({ title, price, type, s, cr, coverImage }: ProductCardProps) {
  return (
    <div
...
function ProductCardMinimal({ title, price, type, s, cr, coverImage, coverAlt }: ProductCardProps) {
  return (
    <div
    ...
    >
      ...
      >
        {coverImage ? (
          ...
          <span
            className="text-xl font-bold inline-flex items-center justify-center h-full w-full"
            style={{ color: s.productBadgeText }}
          >
            {title[0]}
          </span>
...
function ProductCardsGrid({
  ...
  const items: ProductCardItem[] = [
    {
      title: "E-book Template",
      price: "$29.00",
      type: "Digital",
      coverImage: "/images/stress-management-ebook.png",
      coverAlt: "Stress Management ebook cover",
    },
    {
      title: "Design Course",
      price: "$49.00",
      type: "Course",
      coverImage: "/images/design.webp",
      coverAlt: "Design course workspace mockup",
    },
    {
      title: "Icon Pack",
      price: "$9.00",
      type: "Digital",
      coverImage: "/images/iconpack.png",
      coverAlt: "Free icon pack preview panel",
    },
  ];
...
export default function ProfilePage() {
  ...
  return (
    <div className="profile-page-no-radius">
      ...
      <style jsx global>{`
        .profile-page-no-radius *,
        .profile-page-no-radius *::before,
        .profile-page-no-radius *::after {
          border-radius: 0;
        }
      `}</style>
    </div>
