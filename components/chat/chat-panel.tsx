    ...
    <>
      {isMobile && !isOpen && (
        <button
          type="button"
          onClick={onClose}
          className="fixed bottom-20 right-4 z-50 h-12 w-12 bg-orange-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-orange-600 transition-colors"
        >
      ...
      <aside
        className={`
          ...
          ${isMobile && isOpen ? 'fixed inset-y-0 right-0 z-50 w-full max-w-[380px] shadow-2xl' : ''}
        `}
      >
          ...
          <div className="flex items-center gap-1">
            {messages.length > 0 && (
              <button
                type="button"
                onClick={() => setMessages([])}
                className="h-7 px-2 rounded-md flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors text-xs"
                title="Tozalash"
              >
                Clear
              </button>
            ...
            <button
              type="button"
              onClick={onClose}
              className="h-7 w-7 rounded-md flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
